...
try:
    ...
    from FixtureControl.Bismuth_Display_Interface import Display_Interface
    from FixtureControl.Bismuth_ACR_interface import Bismuth_ACR_interface
    ...
    from Bismuth_ACR_interface import Bismuth_ACR_interface
...
class DisplayInterface(object):
    ...
    def init(self):
        ...
        elif self.station_name == 'FATP-DISP-ACR':
            self.Display = Bismuth_ACR_interface()
    ...
    def cl200a_read(self):
        ...
        :return: 1/2 fail -1
        '''
        return self.Display.cl200a_read()

    # for Display Bismuth CAL/ACR stations
    def check_holder_status(self, index=1):
        '''
        Check holder status ,for Bismuth Display CAL/ACR station
        :return: True/False
        '''
        return self.Display.check_holder_status(index)
